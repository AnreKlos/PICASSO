...
function About() {
  ...
  const aboutText = aboutConfig.text || 'Beauty Master — студия, куда приходят за понятным результатом. Мы честно обсуждаем пожелания, подбираем решения под качество волос и кожи, работаем только на проверенных составах и держим высокий стандарт чистоты. В одном визите можно обновить стрижку и цвет, привести в порядок ногти и брови и уйти с ощущением, что о вас действительно позаботились.'
          ...
          {showImages && (
            ...
            <FadeIn>
              <div
                ...
                onClick={() =>
                  setLightbox({
                    src: '/templates/beauty-master/about/demo-about-1.webp',
                    alt: 'Вход в салон',
                  })
                }
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <FadeIn delay={0.1}>
                <div
                  ...
                  onClick={() =>
                    setLightbox({
                      src: '/templates/beauty-master/about/demo-about-2.webp',
                      alt: 'Кабинет салона',
                    })
                  }
                >
              ...
              <FadeIn delay={0.15}>
                <div
                  ...
                  onClick={() =>
                    setLightbox({
                      src: '/templates/beauty-master/about/demo-about-3.webp',
                      alt: 'Интерьер салона',
                    })
                  }
                >
