...
function Gallery() {
  ...
  const defaultWorks = [
    { src: '/templates/beauty-master/gallery/demo-gallery-1.webp', alt: 'Окрашивание волос в салоне' },
    { src: '/templates/beauty-master/gallery/demo-gallery-2.webp', alt: 'Женская стрижка и укладка в салоне' },
    { src: '/templates/beauty-master/gallery/demo-gallery-3.webp', alt: 'Преображение волос после окрашивания' },
    { src: '/templates/beauty-master/gallery/demo-gallery-4.webp', alt: 'Сложное окрашивание волос' },
    { src: '/templates/beauty-master/gallery/demo-gallery-5.webp', alt: 'Укладка волос после салонного ухода' },
    { src: '/templates/beauty-master/gallery/demo-gallery-6.webp', alt: 'Результат работы мастеров' },
  ]
